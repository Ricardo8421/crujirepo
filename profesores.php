...
<body class="bg-lighter-escom">
	...
	<div class="modal fade" id="editDataModal" tabindex="-1" aria-labelledby="editDataLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="editDataLabel">Editando los datos del profesor</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				</div>
				<form>
					<div class="modal-body">
						<fieldset>
							...
							<div class="mb-3">
								...
								<input type="text" id="inputMatriculaProfesor" class="form-control"
									placeholder="Matricula de la Profesor" name="matricula">
							</div>
							<div class="mb-3">
								<div class="form-group">
									...
									<div id="dropdownDepartamentoProfesor" class="input-group">
										<select id="inputDepartamentoProfesor" class="form-control chosen-select"
											style="width:350px;" name="departamento">
							...
							<div class="mb-3">
								...
								<input type="text" id="inputNombreProfesor" class="form-control"
	...
	<script src="js/profesoresAjax.js"></script>
</body>
