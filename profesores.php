...
<body class="bg-lighter-escom">
	...
	<div class="modal fade" id="resetConfirmationModal" tabindex="-1" aria-labelledby="resetConfirmationLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="deleteConfirmationLabel">Confirmación</h5>
				...
				<form>
					<div class="modal-body">
						<input type="hidden" id="resetConfirmationInput">
						<p id="matriculaprofesor"></p>
						<p>¿Seguro que quieres reiniciar el cuestionario de este profesor en el sistema?</p>
						<small class="text-danger">Esta acción no se puede deshacer</small>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
						<button type="submit" class="btn btn-danger" id="resetConfirmationButton">Eliminar</button>
					</div>
				</form>
			</div>
		</div>
